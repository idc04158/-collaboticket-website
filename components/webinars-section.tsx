...
export function WebinarsSection() {
  return (
    <section id="webinars" className="bg-background py-24 lg:py-32">
            ...
            <Card className="border-border bg-card">
              <CardContent className="flex flex-col gap-5 p-8">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <time>{"2026년 3월 15일 (목) 14:00 KST"}</time>
                </div>
                ...
                <Button size="lg" className="w-fit rounded-lg px-8 font-medium">
                  {"사전 신청"}
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card className="border-border bg-card">
              <CardContent className="flex flex-col gap-5 p-8">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  <CalendarDays className="size-4" />
                  <time>{"2026년 1월 20일 (수) 14:00 KST"}</time>
                </div>
                <h4 className="font-sans text-xl font-semibold text-foreground">
                ...
                <Button variant="outline" size="lg" className="w-fit rounded-lg px-8 font-medium">
